...
object HermexColors {
    ...
    // Code block (from iOS MarkdownRenderer.swift:470,488)
    val CodeBlockBackgroundDark = Color(0xFF0A0D12)
    val CodeBlockBackgroundLight = Color(0xFFF2F2F7)

    // Markdown table (from iOS MarkdownRenderer.swift:1257-1273)
    val TableBorderDark = Color(0xFF42444E)
    val TableBorderLight = Color(0xFFE4E4E8)
    val TableRowEvenDark = Color(0xFF18191D)
    val TableRowOddDark = Color(0xFF25262A)
    val TableRowEvenLight = Color(0xFFFFFFFF)
    val TableRowOddLight = Color(0xFFF7F7F9)

    // Syntax highlighting (github-dark inspired palette)
    val SyntaxKeyword = Color(0xFFFF7AB2)
    val SyntaxType = Color(0xFFDABAFF)
    val SyntaxString = Color(0xFFFF8170)
    val SyntaxNumber = Color(0xFFD9C97C)
    val SyntaxComment = Color(0xFF7F8C98)
    val SyntaxPlain = Color(0xFFFFFFFF)
}
